...
// Icons como SVG inline para evitar dependencias
const Icons = {
  Dashboard: () => (
  ...
  return (
    <aside className="sidebar">
      ...
      <nav>
        ...
        <NavLink to="/gastos-fijos" className={({isActive}) => `nav-item ${isActive ? 'active' : ''}`}>
          <Icons.Expenses />
          <span>Gastos Fijos</span>
        </NavLink>
        
        <NavLink to="/costes-productos" className={({isActive}) => `nav-item ${isActive ? 'active' : ''}`}>
          <Icons.Products />
          <span>Costes Productos</span>
        </NavLink>
        
        <NavLink to="/informe-mensual" className={({isActive}) => `nav-item ${isActive ? 'active' : ''}`}>
          <Icons.Report />
      ...
      <div className="app-layout">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/costes-productos" element={<ProductCosts />} />
            <Route path="/informe-mensual" element={<MonthlyReport />} />
